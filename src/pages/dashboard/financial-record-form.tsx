...
export const FinancialRecordForm = () =>{
    ...
    return(
        <div className="form-container">
            <SignedOut>
                <div style={{ textAlign: "center", padding: "20px" }} className="signIn">
                    <p>Please sign in to add a new record.</p>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="button" style={{marginTop:"1rem"}}>Add Record</button>
            </form>
            </SignedIn>
        </div>
    )
